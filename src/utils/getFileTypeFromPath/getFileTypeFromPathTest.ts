...
describe('Finds file type of path depending on the amount of dots, placement of dots, and placemenet of forward slashes', () => {
  // FileType.FILE test
  ...
  it('should return "Path/file is invalid!"', () => {
    expect(() =>
      getFileTypeFromPath('./src/tree/../w.e.e/we.we///')
    ).to.throw();
  });
  // Edge case test
  it('should return "Path/file is invalid!"', () => {
    expect(() =>
      getFileTypeFromPath('./src/tree/')
    ).to.throw();
  });
  // Edge case test
  it('should return "Path/file is invalid!"', () => {
