...
const buildspecLink = 'https://docs.aws.amazon.com/codebuild/latest/userguide/build-spec-ref.html';
const cypressLink = 'https://www.cypress.io/';
const detoxLink = 'https://github.com/wix/Detox/blob/master/docs/APIRef.Configuration.md';
const dockerLink = 'https://docs.docker.com/';
const dockerrunLink = 'https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/single-container-docker-configuration.html';
const dotEnvLink = 'https://www.npmjs.com/package/dotenv';
const ecosystemLink = 'https://pm2.keymetrics.io/docs/usage/application-declaration/';
const editorconfigLink = 'https://editorconfig.org/';
const envvarsLink = 'https://create-react-app.dev/docs/adding-custom-environment-variables/';
...
const gradlewLink = 'https://docs.gradle.org/current/userguide/gradle_wrapper.html';
const gulpfileLink = 'https://gulpjs.com/';
const jestjsLink = 'https://jestjs.io/en/';
const jsdocLink = 'https://jsdoc.app/';
const manifestLink = 'https://developer.mozilla.org/en-US/docs/Mozilla/Add-ons/WebExtensions/manifest.json';
...
const npmdebugLink = 'https://docs.npmjs.com/generating-and-locating-npm-debug-log-files';
...
const packagelockjsonLink = 'https://docs.npmjs.com/configuring-npm/package-lock-json.html';
...
const remotedebugLink = 'https://nodejs.org/en/docs/guides/debugging-getting-started/';
const rundotshLink = 'http://run.sh/';
const sentryLink = 'https://sentry.io/welcome/';
const serverjsLink = 'https://serverjs.io/';
const shrinkwrapLink = 'https://docs.npmjs.com/configuring-npm/shrinkwrap-json.html';
