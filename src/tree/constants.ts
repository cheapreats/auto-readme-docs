...
const fastlaneLink = "https://fastlane.tools/";
...
export const commonInfoLinks: Record<string, string> = {
  ...
  "gradle-wrapper.jar": gradleLink,
  "gradle-wrapper.properties": gradleLink,
  "sentry.properties": sentryLink,
  "AndroidManifest.xml": androidmanifestLink,
  ["fastlane"]: fastlaneLink,
};
