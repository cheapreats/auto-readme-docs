...
<blockquote>📄 [FUNDING.yml](./.github/FUNDING.yml) </blockquote></details>
...
<blockquote>📄 [favicon.ico](./public/favicon.ico) 
📄 [index.html](./public/index.html) </blockquote></details>

<details><summary>📂 [src](./src)               # Source files
<blockquote>📄 [App.tsx](./src/App.tsx) 
<details><summary>📂 [components](./src/components) 
<blockquote>📄 [BadgesSection.tsx](./src/components/BadgesSection.tsx) 
...
<blockquote>📄 [Card.tsx](./src/components/reusable/Card.tsx) 
...
<blockquote>📄 [Demo.gif](./src/images/Demo.gif) </blockquote></details>

📄 [index.css](./src/index.css) 
📄 [index.tsx](./src/index.tsx) 
📄 [react-app-env.d.ts](./src/react-app-env.d.ts) 
<details><summary>📂 [tree](./src/tree) 
<blockquote>📄 [constants.ts](./src/tree/constants.ts) 
...
<blockquote>📄 [createNpmFormatting.ts](./src/utils/createNpmFormatting/createNpmFormatting.ts) 
...
<blockquote>📄 [deleteFileFromPath.ts](./src/utils/deleteFileFromPath/deleteFileFromPath.ts) 
...
<blockquote>📄 [formatLanguages.ts](./src/utils/formatLanguages/formatLanguages.ts) 
...
<blockquote>📄 [generateMarkDownTree.ts](./src/utils/generateMarkDownTree/generateMarkDownTree.ts) 
...
<blockquote>📄 [getAutoGeneratedCommentForPath.ts](./src/utils/getAutoGeneratedCommentForPath/getAutoGeneratedCommentForPath.ts) 
...
<blockquote>📄 [getCopyToClipboardContents.ts](./src/utils/getCopyToClipboardContents/getCopyToClipboardContents.ts) 
...
<blockquote>📄 [getFileIconFromFileType.ts](./src/utils/getFileIconFromFileType/getFileIconFromFileType.ts) 
...
<blockquote>📄 [getFileTypeFromPath.ts](./src/utils/getFileTypeFromPath/getFileTypeFromPath.ts) 
...
<blockquote>📄 [getHyperLinkFromPath.ts](./src/utils/getHyperLinkFromPath/getHyperLinkFromPath.ts) 
...
<blockquote>📄 [getLargestFileNameLengthInLevel.ts](./src/utils/getLargestFileNameLengthInPath/getLargestFileNameLengthInLevel.ts) 
...
<blockquote>📄 [getOwnerAndRepoFromUrl.ts](./src/utils/getOwnerAndRepoFromUrl/getOwnerAndRepoFromUrl.ts) 
...
<blockquote>📄 [repoToBadge.ts](./src/utils/repoToBadge/repoToBadge.ts) 
...
<blockquote>📄 [selectFoldersOnly.ts](./src/utils/selectFoldersOnly/selectFoldersOnly.ts) 
...
<blockquote>📄 [SelectRootCoresTest.ts](./src/utils/selectRootCores/SelectRootCoresTest.ts) 
...
<blockquote>📄 [setCommentForPath.ts](./src/utils/setCommentForPath/setCommentForPath.ts) 
...
<blockquote>📄 [undoDeletions.ts](./src/utils/undoDeletions/undoDeletions.ts) 
